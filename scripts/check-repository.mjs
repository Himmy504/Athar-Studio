...
const windowsIcons = new Set(['src-tauri/icons/icon.ico', 'src-tauri/icons/icon.png']);
...
for (const file of files) {
  ...
  if (file.startsWith('src-tauri/icons/') && !windowsIcons.has(file)) errors.push(`${file}: unused icon for an unsupported package target`);
