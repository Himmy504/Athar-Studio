...
Initial Windows pilot with local Arabic transcription, manual Gemini handoff, caption review, styling, local projects, and MP4/SRT export. Human translation-quality evaluation and hardware pilot requirements are recorded in [the validation document](docs/VALIDATION.md).
