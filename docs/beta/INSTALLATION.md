...
1. Download `Athar-Studio_0.6.0-beta.1_x64-setup.exe` from the GitHub release. It is approximately 135 MB.
...
```powershell
Get-FileHash -LiteralPath '.\Athar-Studio_0.6.0-beta.1_x64-setup.exe' -Algorithm SHA256
```
