...
try {
  ...
  foreach ($taskScript in @('workflow_test.py','layout_test.py','review_tools_test.py','inspector_export_test.py','languages_test.py','rtl_render_test.py','translation_batches_test.py')) {
