...
The native unit-test command excludes packaging resources for that process only. It does not need FFmpeg, a speech model, or a GPU. Installer and media integration checks are separate; see [testing](docs/TESTING.md).
